...
public class ModItems {
	...
	private static void initItemRecipes() {
		...
		// CraftingManager.getInstance().addRecipe(getPlaceHolderStack("ironBar"), new Object[] { "i", Character.valueOf('i'), Block.pressurePlateIron });
		// CraftingManager.getInstance().addRecipe(getPlaceHolderStack("frameSegment"), new Object[] { "iii", Character.valueOf('i'), new ItemStack(placeHolders, 1, 4) });
		// CraftingManager.getInstance().addRecipe(getPlaceHolderStack("glassesLens"), new Object[] { "xix", "iyi", "xix", Character.valueOf('i'), new ItemStack(placeHolders, 1, 4), Character.valueOf('x'), Block.fenceIron, Character.valueOf('y'), Block.glass });
		// CraftingManager.getInstance().addRecipe(getPlaceHolderStack("glassesLens"), new Object[] { "xix", "iyi", "xix", Character.valueOf('x'), new ItemStack(placeHolders, 1, 4), Character.valueOf('i'), Block.fenceIron, Character.valueOf('y'), Block.glass });
		// CraftingManager.getInstance().addRecipe(getPlaceHolderStack("spectrumSensor"), new Object[] { "xix", "xyx", "xzx", Character.valueOf('i'), Block.thinGlass, Character.valueOf('x'), Block.blockRedstone, Character.valueOf('y'), Item.diamond, Character.valueOf('z'), Block.daylightSensor});

		CraftingManager.getInstance().addRecipe(new ItemStack(glasses), new Object[] { "xix", "a a", Character.valueOf('x'), getPlaceHolderStack("frameSegment"), Character.valueOf('i'), getPlaceHolderStack("spectrumSensor"), Character.valueOf('a'), getPlaceHolderStack("glassesLens") });
	}
}
