...
public class ItemPlaceHolder64Renderer implements IItemRenderer {
    ...
    public boolean handleRenderType(ItemStack stack, ItemRenderType type) {
        return ModItems.isPlaceHolderStack("strengthenedIronBar", stack, true) || ModItems.isPlaceHolderStack("atomicFrame", stack, true);
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack stack, Object... data) {
        if (ModItems.isPlaceHolderStack("strengthenedIronBar", stack, true)) {
            switch (type) {
                case ENTITY:
