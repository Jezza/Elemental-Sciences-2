package me.jezzadabomb.es2.client.core;
    ...
    public void onPreRenderSpecials(RenderPlayerEvent.Specials.Pre event) {
        ...
        if (event.entityPlayer instanceof AbstractClientPlayer) {
            ...
            if (!capePlayers.contains(abstractClientPlayer)) {
                ...
                // abstractClientPlayer.getTextureCape().isTextureUploaded(false);
            ...
            while ((str = br.readLine()) != null) {
                if (!str.startsWith("--")) {
                    if (str.contains(":")) {
                        ...
                        ESLogger.warning("Syntax error on line " + linetracker + ": " + str);
                    }
                }
                linetracker++;
            }
